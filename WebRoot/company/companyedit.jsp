        ...
        <input type="hidden" name="compId" id="compId" value=${company.compId} />
        	<table class="table_class4">
            	<tr>
                	...
                	<td class="tdright2"><input type="text" class="input_css3" name="compName" id="compName" value=${company.compName} /></td>
                    <td class="tdleft2">公司简介：</td>
                    <td class="tdright2"><input type="text" class="input_css3" name="compIntro" id="compIntro" value=${company.compIntro} /></td>
                </tr>
                <tr>
                	<td class="tdleft2">部门负责人：</td>
                	<td class="tdright2"><input type="text" class="input_css3" name="compHead" id="compHead" value=${company.compHead} /></td>
                    <td class="tdleft2">部门电话：</td>
                    <td class="tdright2"><input type="text" class="input_css3" name="compPhone" id="compPhone" value=${company.compPhone} /></td>
                </tr>
