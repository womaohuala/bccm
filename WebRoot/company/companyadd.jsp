        ...
        <form action="companysave.shtml" id="form1" name="form1" method="post">
        	<table class="table_class4">
            	<tr>
                	...
                	<td class="tdright2"><input type="text" class="input_css3" name="compName" id="compName"/></td>
                    <td class="tdleft2">公司简介：</td>
                    <td class="tdright2"><input type="text" class="input_css3" name="compIntro" id="compIntro" /></td>
                </tr>
                <tr>
                	<td class="tdleft2">部门负责人：</td>
                	<td class="tdright2"><input type="text" class="input_css3" name="compHead" id="compHead"/></td>
                    <td class="tdleft2">部门电话：</td>
                    <td class="tdright2"><input type="text" class="input_css3" name="compPhone" id="compPhone" /></td>
                </tr>
