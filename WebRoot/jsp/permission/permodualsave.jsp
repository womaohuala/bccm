...
<body  style="background:#e3e8ee;" id="top">
    <div class="ny_right_con">
        ...
        <form action="save.shtml" id="form1" name="form1" method="post">
         <input type="hidden" name="perId" id="perId" value="${permission.perId}" />
         <input type="hidden" name="type" id="tyoe" value="2" />
        	<table class="table_class4">
        		 <tr>
                    <td class="tdleft2">权限模块名称：</td>
                    <td class="tdright2"><input type="text" class="input_css3" name="perName" info="模块名称" id="perName" value="${permission.perName }"/></td>
                	<td class="tdleft2">权限模块描述：</td>
                	<td class="tdright2"><input type="text" class="input_css3" name="perInfo" info="模块描述" id="perInfo" value="${permission.perInfo}" /></td>
                </tr>
