                	...
                	<td class="tdright2">
                	  <select class="select_css4" id="company" name="company" onchange="getProject(this.value);">
	                	  ...
	                	  <c:forEach var="com" items="${comList}">
	                	    <option value="${com.compId}">${com.compName}</option>
	                	  </c:forEach>
                	  </select>
                	 </td>
                    <td class="tdleft2">项目名称：</td>
                    <td class="tdright2"><input type="text" class="input_css3" name="proName" id="proName"/></td>
                </tr>
                
            	<tr>
                	<td class="tdleft2">项目负责人：</td>
                	<td class="tdright2"><input type="text" class="input_css3" name="proHead" id="proHead"/></td>
                    <td class="tdleft2">项目联系电话：</td>
                    <td class="tdright2"><input type="text" class="input_css3" name="proPhone" id="proPhone" /></td>
                </tr>
                  <tr>
                	<td class="tdleft2">项目开始时间：</td>
                	<td class="tdright2"><input type="text"  class="input_css3 Wdate" id="beginTime" name="beginTime" readonly="readonly" onclick="WdatePicker()"/></td>
                    <td class="tdleft2">项目结束时间：</td>
                    <td class="tdright2"><input type="text" class="input_css3 Wdate" id="endTime" name="endTime" readonly="readonly" onclick="WdatePicker()"/></td>
                </tr>
                <tr>
                	<td class="tdleft2">项目信息：</td>
                	<td class="tdright2" colspan="3"><textarea class="textarea_class1" id="proInfo" name="proInfo"></textarea></td>
                </tr>
                
                <tr>
                	<td class="tdleft2">备注：</td>
                	<td class="tdright2" colspan="3"><textarea class="textarea_class1" id="remark" name="remark"></textarea></td>
                </tr>
