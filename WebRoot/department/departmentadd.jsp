        ...
        <form action="departmentsave.shtml" id="form1" name="form1" method="post">
        	<table class="table_class4">
            	<tr>
                	...
                	<td class="tdright2"><input type="text" class="input_css3" name="deptName" id="deptName"/></td>
                    <td class="tdleft2">部门简介：</td>
                    <td class="tdright2"><input type="text" class="input_css3" name="deptInfo" id="deptInfo" /></td>
                </tr>
                <tr>
                	<td class="tdleft2">部门负责人：</td>
                	<td class="tdright2"><input type="text" class="input_css3" name="deptHead" id="deptHead"/></td>
                    <td class="tdleft2">部门电话：</td>
                    <td class="tdright2"><input type="text" class="input_css3" name="deptPhone" id="deptPhone" /></td>
                </tr>
                <tr>
                	<td class="tdleft2">上级部门：</td>
                	<td class="tdright2">经理办</td>
