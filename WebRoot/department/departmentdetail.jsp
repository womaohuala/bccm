        ...
        <input type="hidden" name="compId" id="compId" value=${company.compId} />
        	<table class="table_class4">
            	<tr>
                	...
                	<td class="tdright2"><input type="text" readonly="readonly" class="input_css3" name="deptName" id="deptName" value=${department.deptName} /></td>
                    <td class="tdleft2">公司简介：</td>
                    <td class="tdright2"><input type="text" readonly="readonly" class="input_css3" name="deptInfo" id="deptInfo" value=${department.deptInfo} /></td>
                </tr>
                <tr>
                	<td class="tdleft2">部门负责人：</td>
                	<td class="tdright2"><input type="text" readonly="readonly" class="input_css3" name="deptHead" id="deptHead" value=${department.deptHead} /></td>
