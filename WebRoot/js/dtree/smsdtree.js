...
function Node(id, pid, name, url, title, target, icon, iconOpen, open,newValue,lastValue) {
	this.id = id;
...
function dTree(objName) {
	...
	this.icon = {
		...
		root				:  rootPath + '/img/dtree/base.gif',

		folder			:  rootPath + '/img/dtree/folder.gif',

		folderOpen	: rootPath + '/img/dtree/folderopen.gif',

		node				: rootPath + '/img/dtree/page.gif',

		empty				: rootPath + '/img/dtree/empty.gif',

		line				: rootPath + '/img/dtree/line.gif',

		join				: rootPath + '/img/dtree/join.gif',

		joinBottom	: rootPath + '/img/dtree/joinbottom.gif',

		plus				: rootPath + '/img/dtree/plus.gif',

		plusBottom	: rootPath + '/img/dtree/plusbottom.gif',

		minus				: rootPath + '/img/dtree/minus.gif',

		minusBottom	: rootPath + '/img/dtree/minusbottom.gif',

		nlPlus			: rootPath + '/img/dtree/nolines_plus.gif',

		nlMinus			: rootPath + '/img/dtree/nolines_minus.gif'
...
dTree.prototype.add = function(id, pid, name, url, title, target, icon, iconOpen, open,newValue,lastValue) {

	this.aNodes[this.aNodes.length] = new Node(id, pid, name, url, title, target, icon, iconOpen, open,newValue,lastValue);
...
dTree.prototype.node = function(node, nodeId) {
	...
	if (this.config.useIcons) {
	    ...
	    if(this.config.useCheckbox == true ){
	    	str+= '<input type="checkbox"  name="'+this.obj+'_id"  id="c'+  this.obj + nodeId + '" onclick="javascript:'+this.obj+'.selectCheckbox('+nodeId+')" value="'+node.id+'"/>';
	    	str+= '<input type="hidden"  name="'+this.obj+'_name"  id="c'+  this.obj + nodeId + '"  value="'+node.name+'"/>';
	    	str+= '<input type="hidden"  name="'+this.obj+'_new"   value="'+node.newValue+'"/>';
  		}
		if(node.lastValue){
...
dTree.prototype.s = function(id) {
	...
	document.getElementById("typeId").value = this.aNodes[id].id ; //当前选中的typeid
	return;
